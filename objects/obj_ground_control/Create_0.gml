...
surf_size = 1024;
surf_grid_width = ceil(room_width / surf_size);
surf_grid_height = ceil(room_height / surf_size);
surf_grid = ds_grid_create(surf_grid_width, surf_grid_height);
surf_grid_buf = ds_grid_create(surf_grid_width, surf_grid_height);
